  ...
  return (
    <div className="fixed left-0 top-0 w-64 h-screen bg-gradient-to-b from-blue-50 to-blue-100 p-6 border-r border-blue-100 flex flex-col shadow-lg">
      ...
      <button
        ...
        className="bg-red-500 text-white py-3 px-4 rounded-lg font-semibold hover:bg-red-600 hover:shadow-md transition-all mt-6 text-sm flex items-center justify-center gap-2 w-full transform hover:scale-105"
      >
