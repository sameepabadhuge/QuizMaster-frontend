...
export default function CreateQuiz() {
  ...
  const handleSaveQuiz = () => {
    ...
    // Here you can call your API to save quiz
  };
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="w-64 bg-white shadow-md p-5">
        ...
        <ul>
          <li className="mb-2 font-medium text-blue-600">Create Quiz</li>
          <li className="mb-2 hover:text-blue-600 cursor-pointer">View Results</li>
        </ul>
      </div>
