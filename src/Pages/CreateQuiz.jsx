...
export default function CreateQuiz() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 p-4 overflow-y-auto">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-white p-6 rounded-2xl shadow-xl mb-6 border border-blue-100">
          ...
          {loadingQuizzes ? (
            <div className="text-center py-12">
              ...
              <p className="text-blue-600">Loading your quizzes...</p>
            </div>
          ) : myQuizzes.length === 0 ? (
            <div className="text-center py-12 bg-gradient-to-br from-blue-50 to-white rounded-xl border-2 border-dashed border-blue-200">
              ...
              <p className="text-blue-700 text-lg font-medium mb-2">You haven't created any quizzes yet.</p>
              <p className="text-blue-500">Click "Create New Quiz" to get started!</p>
            </div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              {myQuizzes.map((quiz) => (
                <div
                  key={quiz._id}
                  className="bg-gradient-to-br from-white to-blue-50 p-5 rounded-xl border border-blue-100 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
                >
                  <div className="flex items-start justify-between mb-3">
                    <h3 className="font-bold text-lg text-blue-900 truncate flex-1">{quiz.title}</h3>
                  ...
                  <div className="text-sm space-y-2 mb-4 text-blue-700">
                    ...
                    <div className="flex items-center gap-4 pt-2 border-t border-blue-100">
                      <p className="flex items-center gap-1">
                        ...
                        <span className="text-blue-500">Q's</span>
                      </p>
                      <p className="flex items-center gap-1">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="flex-1 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white py-2.5 px-3 rounded-lg text-sm font-semibold transition-all shadow-md hover:shadow-lg"
                    >
                      ✏️ Edit
                    </button>
                    <button
        ...
        <div className="bg-white p-6 rounded-2xl shadow-xl mb-6 border border-blue-100">
          <h3 className="text-lg font-bold mb-5 text-blue-800 flex items-center gap-2">
            <span className="bg-blue-100 p-2 rounded-lg">📋</span>
            Quiz Details
          </h3>
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-blue-700 mb-1">Quiz Title</label>
              <input type="text" placeholder="Enter quiz title" value={quizTitle}
                onChange={(e) => setQuizTitle(e.target.value)}
                className="w-full p-3 border-2 border-blue-100 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition bg-blue-50/30"
              />
            </div>

            <div>
              <label className="block text-sm font-medium text-blue-700 mb-1">Lecture Name</label>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-blue-700 mb-1">Duration (minutes)</label>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-xl mb-6 border border-blue-100">
          ...
          {questions.map((q, qIndex) => (
            <div key={qIndex} className="mb-6 border-2 border-blue-100 p-5 rounded-xl bg-gradient-to-br from-blue-50/50 to-white shadow-sm">
              <div className="flex items-center justify-between mb-3">
                <label className="text-sm font-bold text-blue-800 bg-blue-100 px-3 py-1 rounded-full">
                  Question {qIndex + 1}
                </label>
                <button  
              ...
              <input type="text" placeholder={`Enter question ${qIndex + 1}`} value={q.text}
                ...
                className="w-full p-3 border-2 border-blue-100 rounded-xl mb-4 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition bg-white"
              />

              <p className="text-sm font-medium text-blue-700 mb-2">Options (select the correct answer)</p>
                ...
                {q.options.map((opt, oIndex) => (
                  <div key={oIndex} className={`flex gap-3 items-center p-2 rounded-lg transition-all ${
                    ...
                    <input type="text" placeholder={`Option ${oIndex + 1}`} value={opt}
                      ...
                      className="flex-1 p-3 border-2 border-blue-100 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition bg-white"
                    />
          ...
          <button onClick={addQuestion} className="bg-gradient-to-r from-blue-500 to-blue-600 text-white px-6 py-3 rounded-xl font-semibold hover:from-blue-600 hover:to-blue-700 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-1">
            ➕ Add Question
          </button>
        </div>
